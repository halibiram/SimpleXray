...
pub extern "system" fn Java_com_simplexray_an_performance_PerformanceManager_nativeOptimizeKeepAlive(
    ...
    #[cfg(target_os = "android")]
    {
        ...
        unsafe {
            let _ = setsockopt(fd, SOL_TCP, TCP_KEEPIDLE as i32, &keepidle as *const _ as *const _, std::mem::size_of::<i32>() as libc::socklen_t);
            let _ = setsockopt(fd, SOL_TCP, TCP_KEEPINTVL as i32, &keepintvl as *const _ as *const _, std::mem::size_of::<i32>() as libc::socklen_t);
            let _ = setsockopt(fd, SOL_TCP, TCP_KEEPCNT as i32, &keepcnt as *const _ as *const _, std::mem::size_of::<i32>() as libc::socklen_t);
        }
    }
    #[cfg(not(target_os = "android"))]
    {
